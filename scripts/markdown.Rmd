...
#    theme_minimal() + 
#    labs(x = "Percentage of all passengers", y = "Nationality")

# Peer review AS: I agree with MV. A visual would be nice here. 
...
#Peer review AS: this looks interesting/cool/advanced, but somewhat difficult to interpret. I would like to know about about this research question and  the code used to create this visual.  
```
